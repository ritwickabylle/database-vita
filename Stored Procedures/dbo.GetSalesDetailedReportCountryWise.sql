...
CREATE     procedure [dbo].[GetSalesDetailedReportCountryWise]   -- exec GetSalesDetailedReportCountryWise '2023-02-01', '2023-02-28',33,'VATSAL007'                      
(                      
@fromDate Date=null,                      
@toDate Date=null,                    
@tenantId int=null,                
...
begin                
select BuyerCountryCode as Description,(select case when (irnno is null or irnno ='') then InvoiceNumber else irnno end)  as Invoicenumber,   
BuyerName as CustomerName,  
 ...
 and BuyerCountryCode =@subcode
 --and orignalSupplyDate < @fromDate                
AND TenantId=@tenantId            
group by IRNNo,effdate,InvoiceNumber,BillingReferenceId,VatRate ,BuyerCountryCode,BuyerName order by BuyerCountryCode    
