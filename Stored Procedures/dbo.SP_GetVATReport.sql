...
CREATE       PROCEDURE [dbo].[SP_GetVATReport]              --exec SP_GetVATReport '2023-11-01','2023-11-30',148
...
insert into @VatReport values (19,'14. Corrections from previous period (between SAR 15,000±)',0,0,0);  
