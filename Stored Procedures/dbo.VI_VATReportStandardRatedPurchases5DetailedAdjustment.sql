...
CREATE          procedure [dbo].[VI_VATReportStandardRatedPurchases5DetailedAdjustment]     --EXEC [VI_VATReportStandardRatedPurchases5DetailedAdjustment] '2023-10-01', '2023-10-30' ,127
(    
@fromdate date,    
@todate date,  
@tenantId int=null  
