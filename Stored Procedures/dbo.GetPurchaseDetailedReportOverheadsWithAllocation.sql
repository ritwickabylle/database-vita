...
SET ANSI_NULLS ON
GO
CREATE     procedure [dbo].[GetPurchaseDetailedReportOverheadsWithAllocation]   -- exec GetPurchaseDetailedReportOverheadsWithAllocation '2022-12-01', '2022-12-30',19,'VATPUR009'                            
(                            
@fromDate Date=null,                            
@toDate Date=null,                          
@tenantId int=null,                      
...
begin                      
 ...
 where CAST(IssueDate AS DATE)>=@fromDate and CAST(IssueDate AS DATE)<=@toDate and PurchaseCategory like '%Overhead%'  and AffiliationStatus='Y'                  
