...
SET ANSI_NULLS ON
GO
CREATE    procedure [dbo].[GetDebitNotePurchaseDetailedReporteffdatebrady] --exec   GetDebitDetailedReportEffdatebrady '2022-01-01','2024-03-30',140,'any','5678912'    
(                    
@fromDate DATE=NULL,                
@toDate DATE=NULL,    
@tenantId INT=NULL,          
...
and invoicetype like 'DN Purchase%' and VatCategoryCode is not null        
...
from VI_importstandardfiles_Processed where TenantId=@tenantId and              
CAST(IssueDate AS DATE)>=@fromDate and CAST(IssueDate AS DATE)<=@toDate              
and invoicetype like 'DN Purchase%' and VatCategoryCode not like '0'                 
