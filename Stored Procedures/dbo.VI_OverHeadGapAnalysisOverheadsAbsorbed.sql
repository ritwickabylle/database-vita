...
SET ANSI_NULLS ON
GO
CREATE       procedure [dbo].[VI_OverHeadGapAnalysisOverheadsAbsorbed]    -- exec VI_OverHeadGapAnalysisOverheadsAbsorbed '2023-01-01','2023-12-31'  ,50
(  
@fromdate datetime,
@todate datetime,
@tenantId int=null
...
select  isnull(sum((case when (invoicetype like 'Purchase%')    
 ...
 as amount,  
 effdate,
 'Amount of Overheads Absorbed (As per Prev Yr %)'  
