...
SET ANSI_NULLS ON
GO
CREATE     procedure [dbo].[GetPurchaseDetailedReportCountryWise]   -- exec GetPurchaseDetailedReportCountryWise '2022-12-01', '2022-12-30',19,'VATPUR008'                        
(                        
@fromDate Date=null,                        
@toDate Date=null,                      
@tenantId int=null,                  
...
begin                  
  select   buyercountrycode as description,          
...
group by IssueDate,PurchaseCategory,RCMApplicable,VATDeffered,InvoiceNumber ,VatRate ,BuyerCountryCode,BuyerName  order by     BuyerCountryCode               
