...
CREATE         procedure [dbo].[GetDebitNotePurchaseDetailedReportIsseudate]   --  exec GetDebitNotePurchaseDetailedReportIssuedate '2022-11-01', '2022-11-30'      
(      
...
isnull(sum(case when ( VatCategoryCode='S'  and RCMApplicable='0' and VATDeffered='0' and left(BuyerCountryCode,2) <> 'SA')   
Then isnull(LineNetAmount ,0) else 0 end ),0) as ImportVATCustoms,  
isnull(sum(case when ( VatCategoryCode='S'  and RCMApplicable='0' and VATDeffered='1' and left(BuyerCountryCode,2) <> 'SA')   
