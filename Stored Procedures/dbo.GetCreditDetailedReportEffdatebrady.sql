...
CREATE     procedure [dbo].[GetCreditDetailedReportEffdatebrady]  --exec   GetCreditDetailedReportEffdatebrady '2023-10-01','2023-10-31',127,'any',null    
(                    
@fromDate DATE=NULL,                
@toDate DATE=NULL,    
@tenantId INT=NULL,          
...
and invoicetype like 'Credit Note%' and VatCategoryCode is not null        
