...
CREATE  procedure [dbo].[GetCreditNotePurchaseDetailedReport]   --  exec GetCreditNotePurchaseDetailedReport '2022-11-01', '2022-11-30' ,148,null,'any','55638651'       
(          
	@fromDate Date=null,          
	@toDate Date=null,    
	@tenantId int=null ,  
   ...
   if @code is null or @sql is null or len(@sql)=0
	...
	exec GetCreditNotePurchaseDetailedReporteffDate @fromDate,@toDate,@tenantId,@type,@text
	end
...
---  exec GetCreditNotePurchaseDetailedReportIssueDate @fromDate,@toDate,@tenantId  
