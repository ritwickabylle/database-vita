...
SET ANSI_NULLS ON
GO
CREATE    procedure [dbo].[GetPurchaseDetailedReportExempt]   -- exec GetPurchaseDetailedReportExempt '2022-12-01', '2022-12-30',19,'VATPUR006'                          
(                          
@fromDate Date=null,                          
@toDate Date=null,                        
@tenantId int=null,                    
...
begin                    
 ...
 where CAST(IssueDate AS DATE)>=@fromDate and CAST(IssueDate AS DATE)<=@toDate and InvoiceType like 'Purchase%'  and VatCategoryCode like 'E'                 
