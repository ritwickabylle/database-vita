...
SET ANSI_NULLS ON
GO
CREATE       procedure [dbo].[VI_VATReportImportSubjecttoVATPaid5DetailedAdjustment]     --EXEC [VI_VATReportImportSubjecttoVATPaid5DetailedAdjustment]  '2023-10-01', '2023-10-30' ,127
(    
@fromdate date,    
@todate date,  
@tenantId int=null  
