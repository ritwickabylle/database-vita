...
CREATE      procedure [dbo].[GetSalesDetailedReportCustomerWise]   -- exec GetSalesDetailedReportCustomerWise '2022-12-01', '2022-12-30',19,'VATSAL006'                        
(                        
@fromDate Date=null,                        
@toDate Date=null,                      
@tenantId int=null,                  
...
begin                  
select BuyerName as CustomerName,(select case when (irnno is null or irnno ='') then InvoiceNumber else irnno end)  as Invoicenumber,                        
...
group by IRNNo,effdate,InvoiceNumber,BillingReferenceId,VatRate ,BuyerName order by BuyerName    
