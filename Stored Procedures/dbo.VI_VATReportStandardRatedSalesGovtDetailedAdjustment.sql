...
SET ANSI_NULLS ON
GO
CREATE       procedure [dbo].[VI_VATReportStandardRatedSalesGovtDetailedAdjustment]     --EXEC [VI_VATReportStandardRatedSalesGovtDetailedAdjustment]  '2023-10-01', '2023-10-30' ,127
(@Fromdate date,    
 @Todate date,  
 @tenantId int=null  
) as    
