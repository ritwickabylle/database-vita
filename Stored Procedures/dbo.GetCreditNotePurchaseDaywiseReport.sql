...
CREATE     procedure [dbo].[GetCreditNotePurchaseDaywiseReport]   --  exec GetCreditNotePurchaseDaywiseReport '2022-06-01', '2022-06-31',2        
(        
@fromDate Date=null,        
@toDate Date=null,  
@tenantId int=null  
...
--exec GetCreditNotePurchaseDaywiseReportIssuedate @fromDate,@toDate,@tenantId
 
 exec GetCreditNotePurchaseDaywiseReporteffdate @fromDate,@toDate,@tenantId
--select         
--select   format(Issuedate ,'yyyy-MM-dd')  --IssueDate   
...
--@fromDate and @toDate and invoicetype like 'CN Purchase%'        
