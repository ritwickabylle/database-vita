...
SET ANSI_NULLS ON
GO
CREATE   procedure [dbo].[GetPurchaseDetailedReportRCMApplicable]   -- exec GetPurchaseDetailedReportRCMApplicable '2022-12-01', '2022-12-30',19,'VATPUR005'                        
(                        
@fromDate Date=null,                        
@toDate Date=null,                      
@tenantId int=null,                  
...
begin                  
 ...
 where CAST(IssueDate AS DATE)>=@fromDate and CAST(IssueDate AS DATE)<=@toDate and InvoiceType like 'Purchase%'   and RCMApplicable is not null and RCMApplicable=1                 
