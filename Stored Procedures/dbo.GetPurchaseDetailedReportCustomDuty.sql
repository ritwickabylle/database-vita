...
SET ANSI_NULLS ON
GO
CREATE    procedure [dbo].[GetPurchaseDetailedReportCustomDuty]   -- exec GetPurchaseDetailedReportCustomDuty '2022-12-01', '2022-12-30',19,'VATPUR003'                        
(                        
@fromDate Date=null,                        
@toDate Date=null,                      
@tenantId int=null,                  
...
begin                  
 ...
 where CAST(IssueDate AS DATE)>=@fromDate and CAST(IssueDate AS DATE)<=@toDate and InvoiceType like 'Purchase%'   and CustomsPaid is not null and CustomsPaid>0                 
