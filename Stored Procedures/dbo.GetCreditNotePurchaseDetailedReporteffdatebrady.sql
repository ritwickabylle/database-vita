...
SET ANSI_NULLS ON
GO
CREATE     PROC [dbo].[GetCreditNotePurchaseDetailedReporteffdatebrady]
(          
@fromDate Date=null,        -- Exec  GetCreditNotePurchaseDetailedReporteffdatebrady '2022-01-01','2024-03-30',148,'any' ,'55638651'
...
and invoicetype like 'CN%'  and VatCategoryCode is not null        
