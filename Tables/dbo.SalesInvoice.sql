...
GO
ALTER TABLE [dbo].[SalesInvoice] ADD CONSTRAINT [PK_SalesInvoice] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoice_TenantId] ON [dbo].[SalesInvoice] ([TenantId]) ON [PRIMARY]
GO
