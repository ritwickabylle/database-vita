...
GO
ALTER TABLE [dbo].[PurchaseCreditNoteSummary] ADD CONSTRAINT [PK_PurchaseCreditNoteSummary] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseCreditNoteSummary_TenantId] ON [dbo].[PurchaseCreditNoteSummary] ([TenantId]) ON [PRIMARY]
GO
