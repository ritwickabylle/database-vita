CREATE TABLE [dbo].[CreditNoteSummary]
(
...
GO
ALTER TABLE [dbo].[CreditNoteSummary] ADD CONSTRAINT [PK_CreditNoteSummary] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_CreditNoteSummary_TenantId] ON [dbo].[CreditNoteSummary] ([TenantId]) ON [PRIMARY]
GO
