...
GO
ALTER TABLE [dbo].[DraftItem] ADD CONSTRAINT [PK_DraftItem] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DraftItem_TenantId] ON [dbo].[DraftItem] ([TenantId]) ON [PRIMARY]
GO
