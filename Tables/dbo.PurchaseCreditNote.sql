CREATE TABLE [dbo].[PurchaseCreditNote]
(
...
GO
ALTER TABLE [dbo].[PurchaseCreditNote] ADD CONSTRAINT [PK_PurchaseCreditNote] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseCreditNote_TenantId] ON [dbo].[PurchaseCreditNote] ([TenantId]) ON [PRIMARY]
GO
