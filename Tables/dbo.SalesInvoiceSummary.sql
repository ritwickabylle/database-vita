CREATE TABLE [dbo].[SalesInvoiceSummary]
(
...
GO
ALTER TABLE [dbo].[SalesInvoiceSummary] ADD CONSTRAINT [PK_SalesInvoiceSummary] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoiceSummary_TenantId] ON [dbo].[SalesInvoiceSummary] ([TenantId]) ON [PRIMARY]
GO
