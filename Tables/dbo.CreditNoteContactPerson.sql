CREATE TABLE [dbo].[CreditNoteContactPerson]
(
...
GO
ALTER TABLE [dbo].[CreditNoteContactPerson] ADD CONSTRAINT [PK_CreditNoteContactPerson] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_CreditNoteContactPerson_TenantId] ON [dbo].[CreditNoteContactPerson] ([TenantId]) ON [PRIMARY]
GO
