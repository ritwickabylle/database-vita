CREATE TABLE [dbo].[DraftContactPerson]
(
...
GO
ALTER TABLE [dbo].[DraftContactPerson] ADD CONSTRAINT [PK_DraftContactPerson] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DraftContactPerson_TenantId] ON [dbo].[DraftContactPerson] ([TenantId]) ON [PRIMARY]
GO
