...
[CapitalInvestmentDate] [datetime2] NULL,
[VendorConstitution] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[ImportBatchData] ADD CONSTRAINT [PK_ImportBatchData] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_ImportBatchData_TenantId] ON [dbo].[ImportBatchData] ([TenantId]) ON [PRIMARY]
GO
