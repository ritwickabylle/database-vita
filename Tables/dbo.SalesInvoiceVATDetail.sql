CREATE TABLE [dbo].[SalesInvoiceVATDetail]
(
...
GO
ALTER TABLE [dbo].[SalesInvoiceVATDetail] ADD CONSTRAINT [PK_SalesInvoiceVATDetail] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoiceVATDetail_TenantId] ON [dbo].[SalesInvoiceVATDetail] ([TenantId]) ON [PRIMARY]
GO
