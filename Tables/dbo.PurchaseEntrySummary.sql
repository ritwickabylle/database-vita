CREATE TABLE [dbo].[PurchaseEntrySummary]
(
...
GO
ALTER TABLE [dbo].[PurchaseEntrySummary] ADD CONSTRAINT [PK_PurchaseEntrySummary] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseEntrySummary_TenantId] ON [dbo].[PurchaseEntrySummary] ([TenantId]) ON [PRIMARY]
GO
