CREATE TABLE [dbo].[PurchaseDebitNoteItem]
(
...
GO
ALTER TABLE [dbo].[PurchaseDebitNoteItem] ADD CONSTRAINT [PK_PurchaseDebitNoteItem] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseDebitNoteItem_TenantId] ON [dbo].[PurchaseDebitNoteItem] ([TenantId]) ON [PRIMARY]
GO
