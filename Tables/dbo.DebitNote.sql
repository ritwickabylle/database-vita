...
GO
ALTER TABLE [dbo].[DebitNote] ADD CONSTRAINT [PK_DebitNote] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DebitNote_TenantId] ON [dbo].[DebitNote] ([TenantId]) ON [PRIMARY]
GO
