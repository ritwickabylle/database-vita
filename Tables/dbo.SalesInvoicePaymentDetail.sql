...
GO
ALTER TABLE [dbo].[SalesInvoicePaymentDetail] ADD CONSTRAINT [PK_SalesInvoicePaymentDetail] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoicePaymentDetail_TenantId] ON [dbo].[SalesInvoicePaymentDetail] ([TenantId]) ON [PRIMARY]
GO
