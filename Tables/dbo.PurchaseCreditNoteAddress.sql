...
GO
ALTER TABLE [dbo].[PurchaseCreditNoteAddress] ADD CONSTRAINT [PK_PurchaseCreditNoteAddress] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseCreditNoteAddress_TenantId] ON [dbo].[PurchaseCreditNoteAddress] ([TenantId]) ON [PRIMARY]
GO
