CREATE TABLE [dbo].[PurchaseCreditNoteContactPerson]
(
...
GO
ALTER TABLE [dbo].[PurchaseCreditNoteContactPerson] ADD CONSTRAINT [PK_PurchaseCreditNoteContactPerson] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_PurchaseCreditNoteContactPerson_TenantId] ON [dbo].[PurchaseCreditNoteContactPerson] ([TenantId]) ON [PRIMARY]
GO
