CREATE TABLE [dbo].[SalesInvoiceAddress]
(
...
GO
ALTER TABLE [dbo].[SalesInvoiceAddress] ADD CONSTRAINT [PK_SalesInvoiceAddress] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoiceAddress_TenantId] ON [dbo].[SalesInvoiceAddress] ([TenantId]) ON [PRIMARY]
GO
