CREATE TABLE [dbo].[DebitNoteSummary]
(
...
GO
ALTER TABLE [dbo].[DebitNoteSummary] ADD CONSTRAINT [PK_DebitNoteSummary] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_DebitNoteSummary_TenantId] ON [dbo].[DebitNoteSummary] ([TenantId]) ON [PRIMARY]
GO
