...
GO
ALTER TABLE [dbo].[CustomerDocuments] ADD CONSTRAINT [PK_CustomerDocuments] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_CustomerDocuments_TenantId] ON [dbo].[CustomerDocuments] ([TenantId]) ON [PRIMARY]
GO
