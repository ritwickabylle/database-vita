...
[isOtherCharges] [bit] NOT NULL CONSTRAINT [DF__SalesInvo__isOth__550B8C31] DEFAULT (CONVERT([bit],(0)))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[SalesInvoiceItem] ADD CONSTRAINT [PK_SalesInvoiceItem] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SalesInvoiceItem_TenantId] ON [dbo].[SalesInvoiceItem] ([TenantId]) ON [PRIMARY]
GO
