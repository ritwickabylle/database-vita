...
[DraftStatus] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[Draft] ADD CONSTRAINT [PK_Draft] PRIMARY KEY CLUSTERED ([Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_Draft_TenantId] ON [dbo].[Draft] ([TenantId]) ON [PRIMARY]
GO
